...
const TodoForm = () => {
  ...
  const addTodo = useMutation<Todo, Error, Todo>({
    ...
    onMutate: (newTodo: Todo) => {
      const prviousTodos = queryClient.getQueryData<Todo[]>(["todos"]);
  ...
  return (
    ...
    // Now lets see how we can improve the user exprience by implementing an optimistic update.
    <>
      {addTodo.error && (
